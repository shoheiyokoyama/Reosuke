...
//  Reosuke
//
//  Created by Shohei Yokoyama on 2015/12/02.
...
- (void)viewDidLoad {
    ...
    self.tableView.tableHeaderView = ({
        ...
        imageView.image = [UIImage imageNamed:@"joe"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SideMenuNavigationController *navigationController;
    if (indexPath.section == 0 && indexPath.row == 0) {
        HomeViewController *homeViewController = [[HomeViewController alloc] init];
        navigationController = [[SideMenuNavigationController alloc] initWithRootViewController:homeViewController];
